<template lang="">
	...
	<!-- <CreateTreeModal ref="theCreateModal" :id="createId" :type="createType" :getTypeList="getTypeList" /> -->
  <!-- <EditTreeModal ref="theEditModal" :id="editId" :label="editLabel" :getTypeList="getTypeList"/> -->
  <DialogModal 
    :show="show"
...
import DailogModal from '@/components/Admin/VideoType/DialogModal.vue'
